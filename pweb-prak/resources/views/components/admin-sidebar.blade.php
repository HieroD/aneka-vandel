    ...
    <nav class="py-3 flex-1">
        @foreach ($items as $item)
            ...
            <a
                ...
                @class([
                    'flex items-center gap-2.5 px-5 py-2.5 text-[13px] font-medium text-text-muted hover:bg-surface-2 hover:text-text',
                    'bg-primary-soft text-primary font-semibold mx-2 px-3 rounded-lg w-[calc(100%-16px)]' => $isActive,
                ])
            >
