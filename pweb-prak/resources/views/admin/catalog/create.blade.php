<x-admin-layout title="Tambah Produk">
    ...
    <h1 class="text-[22px] font-bold text-text mb-1">Tambah Produk Baru</h1>
    <p class="text-[13px] text-text-subtle mb-7">Isi semua informasi produk yang ingin ditambahkan ke katalog.</p>
    ...
    <div class="bg-white rounded-xl border border-border p-8 max-w-3xl">
        <form action="{{ route('catalog.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-6">
            ...
            <div class="flex gap-3 pt-2">
                ...
                <x-button type="submit" variant="primary" class="flex-1">Simpan Produk</x-button>
            </div>
