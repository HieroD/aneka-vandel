                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($orders as $order)
                            @forelse ($order->products as $product)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 text-gray-600">{{ \Carbon\Carbon::parse($order->order_date)->translatedFormat('d M Y') }}</td>
                                    <td class="px-6 py-4 text-gray-600">{{ $product->name }}</td>
                                    <td class="px-6 py-4 text-gray-600">Rp {{ number_format($product->price * $product->pivot->quantity, 0, ',', '.') }}</td>
                                    <td class="px-6 py-4">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <span class="">Menunggu Pembayaran</span>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
