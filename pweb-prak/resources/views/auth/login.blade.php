<x-auth-layout title="Sign In">
    ...
    <h1 class="text-white text-2xl font-bold text-center mb-7">Sign in</h1>
    ...
    <form action="{{ route('login.store') }}" method="POST" id="loginForm">
        ...
        <div class="mb-4">
            <x-input name="email" type="email" label="Email" placeholder="Enter your email" autocomplete="email" />
        </div>

        <div class="mb-4">
            <x-input name="password" type="password" label="Password" placeholder="Enter your password" autocomplete="current-password" />
        </div>

        <div class="text-right text-xs text-white/60 mb-5">
